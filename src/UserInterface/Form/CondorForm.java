...
public class CondorForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `CondorForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "Condor.jpeg" ubicada en el directorio
    ...
    public CondorForm(){
        ...
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/Condor.jpeg"; 
