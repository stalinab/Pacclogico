...
public class GorilaForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `GorilaForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "Gorila.jpeg" ubicada en el directorio
    ...
    public GorilaForm(){
        ...
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/Gorila.jpeg"; 
