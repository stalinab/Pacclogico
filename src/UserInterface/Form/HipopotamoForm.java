...
public class HipopotamoForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `HipopotamoForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "Hipopotamo.jpeg" ubicada en el directorio
     ...
     */
    public HipopotamoForm(){
        JLabel label = new JLabel();
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/Hipopotamo.jpeg"; 
