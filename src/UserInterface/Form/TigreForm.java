...
public class TigreForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `TigreForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "Tigre.jpeg" ubicada en el directorio
    ...
    public TigreForm(){
        ...
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/Tigre.jpeg"; 
