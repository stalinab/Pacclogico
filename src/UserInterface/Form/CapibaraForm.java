...
public class CapibaraForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `CapibaraForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "Capibara.jpeg" ubicada en el directorio
    ...
    public CapibaraForm(){
        ...
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/Capibara.jpeg"; 
