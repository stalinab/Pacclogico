...
public class LeonForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `LeonForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "Leon.jpeg" ubicada en el directorio
    ...
    public LeonForm(){
        ...
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/Leon.jpeg"; 
