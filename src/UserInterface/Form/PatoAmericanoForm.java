...
public class PatoAmericanoForm extends JFrame{
    /**
     * Este fragmento de código define un constructor para la clase `PatoAmericanoForm`. Dentro del constructor:
     * 1. Crea un nuevo componente `JLabel` llamado `label`.
     * 2. Especifica la ruta del archivo de una imagen llamada "PatoAmericano.jpeg" ubicada en el directorio
     ...
     */
    public PatoAmericanoForm(){
        JLabel label = new JLabel();
        String imagePath = "../Pacclogico/src/UserInterface/Resource/Img/PatoAmericano.jpeg"; 
